...
%help lines
\draw[gray] (0, 0) -- (0, 3.2);
\draw[gray] (1.8, 0) -- (1.8, 3.2);
\draw[gray] (3.6, 0) -- (3.6, 1.7);
\draw[gray] (5.4, 0) -- (5.4, 3.2);
\draw[gray] (7.2, 0) -- (7.2, 2.7);
\draw[gray] (9, 0) -- (9, 2.2);
\draw[gray] (10.8, 0) -- (10.8, 3.2);
% vertices
\node[vertex] (1) at  (0, 0) {};
...
\draw[edge, dashed] (6) to[bend left=20] (2);
\draw[edge, white, line width = 2pt] (1) to[bend left=20] (4);
\draw[edge, dashed] (1) to[bend left=20] (4);

%intervals
\draw[interval] (5.4, 1.2) -- (7.2, 1.2);
\draw[interval] (3.6, 1.7) -- (7.2, 1.7);
\draw[interval] (5.4, 2.2) -- (9, 2.2);
\draw[interval] (1.8, 2.7) -- (7.2, 2.7);
\draw[interval] (5.4, 3.2) -- (10.8, 3.2);
\draw[interval] (0, 3.2) -- (1.8, 3.2);

%oznake
\node[anchor=west] at (7.2, 1.2) {$I_1$};
\node[anchor=west] at (7.2, 1.7) {$I_2$};
\node[anchor=west] at (9, 2.2) {$I_3$};
\node[anchor=west] at (7.2, 2.7) {$I_4$};
\node[anchor=west] at (10.8, 3.2) {$I_5$};
\node[anchor=west] at (1.8, 3.2) {$I_0$};
