...
%intervals
\draw[interval] (5.5, 1.25) -- (7, 1.3);
\draw[interval] (4.2, 1.75) -- (7, 1.8);
\draw[interval] (5.6, 2.2) -- (8.4, 2.2);
\draw[interval] (1.4, 2.7) -- (7, 2.7);
\draw[interval] (5.6, 3.2) -- (11.2, 3.2);
\draw[interval] (0, 3.2) -- (1.4, 3.2);
