...
\newcommand{\imeavtorja}{Tom Gornik} % ime avtorja
\newcommand{\imementorja}{izr.~prof.~dr.~Aleš Vavpetič} % akademski naziv in ime mentorja, uporabi poln naziv, prof.~dr.~, doc.~dr., ali izr.~prof.~dr.
\newcommand{\imesomentorja}{} % akademski naziv in ime somentorja, če ga imate
\newcommand{\naslovdela}{Izrek Šarkovskega}
...
\begin{definicija}
	Pravimo, da interval $I$ pokrije interval $J$, če je $J \subset f(I)$. Relacijo ponavadi zapišemo kot $I \to J$.
\end{definicija}
\begin{lema}
Če je $[a_1, a_2] \to [a_1, a_2]$, potem ima funkcija $f$ fiksno točko na intervalu $[a_1, a_2]$.
\end{lema}
\begin{proof}
Sledi iz izreka o vmesni vrednosti.
\end{proof}
\begin{lema}
Če je $[a_1, a_2] \to [a_1, a_2]$, potem ima funkcija $f$ fiksno točko na intervalu $[a_1, a_2]$.
\end{lema}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=\textwidth]{images/odrezana_funkcija.pdf}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=\textwidth]{images/sedemcikel.pdf}
% \caption[caption za v kazalo]{Dolg caption pod sliko}
  \caption[Primer vektorske slike.]{Primer vektorske slike z oznakami v enaki pisavi, kot jo
     uporablja \LaTeX{}.  Narejena je s programom Inkscape, \LaTeX{} oznake so importane v
     Inkscape iz pomožnega PDF.}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=\textwidth]{images/devetcikel.pdf}
% \caption[caption za v kazalo]{Dolg caption pod sliko}
  \caption[Primer vektorske slike.]{Primer vektorske slike z oznakami v enaki pisavi, kot jo
     uporablja \LaTeX{}.  Narejena je s programom Inkscape, \LaTeX{} oznake so importane v
     Inkscape iz pomožnega PDF.}
