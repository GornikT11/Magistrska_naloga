...
\[ f(x) = \begin{cases}
  ...
  \end{cases}
  \]
Funkcija $f$ ima samo dve periodični točki. To sta točki $a$ in $b$. Obe pa imata periodo 2. Ker nobena točka prostora $X$ ni negibna točka za funkcijo $f$, prostor $X$ ni prostor Šarkovskega.
\end{proof}
...
\begin{figure}[h]
  \centering
  \import{images/}{varsavska_kroznica.tex}
