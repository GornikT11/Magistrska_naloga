...
% \caption[caption za v kazalo]{Dolg caption pod sliko}
  ...
  \label{fig:3cikla}
\end{figure}
Črtkane puščice na sliki~\ref{fig:3cikla} nakazujejo, kam se s funkcijo $f$ slikajo točke. Velja 
